            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <a href="{{ url('/profil') }}/{{$job->slug}}">
                      ...
                      <img src="{{Config::get('url')}}{{$job->pic}}" class="img-rounded"  style="width:100px; height:100px; margin:5px; border:1px solid #ddd; padding:5px">
                      </div>
                    ...
                    <hr>
                        ...
                        <div class="col-md-12" >
                          ...
                          <a href="mailto:{{$job->contact_email}}" class="email_link" style="border:solid #1D62F0 1px; padding:5px">{{$job->contact_email}}</a></p>
                        </div>
